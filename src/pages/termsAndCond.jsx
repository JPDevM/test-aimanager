  ...
  return (
    <Fragment>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-36">
        <p className="leading-relaxed text-5xl font-bold pt-8">
          Términos y Condiciones de Uso
        </p>
        <p className="leading-relaxed text-2xl font-semibold text-gray-600 pt-8">
          INFORMACIÓN RELEVANTE
        </p>
        <p className="leading-relaxed text-base text-justify text-gray-500 font-normal pt-2">
        ...
        <p className="leading-relaxed text-base text-justify text-gray-500 font-normal pt-2">
          ...
          nuestros productos. AiManager no asume la responsabilidad en caso de
        ...
        <p className="leading-relaxed text-base text-justify text-gray-500 font-normal pt-2">
          AiManager a través de su sitio web concede una licencia para que los
        ...
        <p className="leading-relaxed text-base text-justify text-gray-500 font-normal pt-2">
          ...
          funcionamiento en condiciones normal pt-2es de los productos y sólo se
        ...
        <p className="leading-relaxed text-base text-justify text-gray-500 font-normal pt-2">
          Este AiManager garantiza que la información personal que usted envía
        ...
        <p className="leading-relaxed text-base text-justify text-gray-500 font-normal pt-2">
          AiManager reserva los derechos de cambiar o de modificar estos
