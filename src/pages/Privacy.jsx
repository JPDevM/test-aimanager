...
const Privacy = () => {
  return (
    <Fragment>
      {/*  Page content */}{' '}
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-36">
        <p className="pt-4 font-bold text-5xl">Política de Privacidad</p>
        <p className="leading-relaxed text-2xl font-semibold text-gray-600 pt-8">
          AiManager te informa sobre su Política de Privacidad respecto del
          ...
          contratación de servicios a través del sitio Web aimanager.online.
        </p>
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
        ...
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
          Correo electrónico: info@aimanager.online
        </p>
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
          Sitio Web: aimanager.online
        </p>
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed"></p>
        <p className="leading-relaxed text-2xl font-semibold text-gray-600 pt-8">
        ...
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
          ...
          durante un tiempo considerable. Principio de integridad y
          confidencialidad: Tus datos serán tratados de tal manera que su
          seguridad, confidencialidad e integridad esté garantizada. Debes saber
          que el Titular toma las precauciones necesarias para evitar el acceso
          no autorizado o uso indebido de los datos de sus usuarios por parte de
          terceros.
        </p>
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed"></p>
        <p className="leading-relaxed text-2xl font-semibold text-gray-600 pt-8">
        ...
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
          ...
          personal. Los casos en los que sí proporcionas tus datos personales
          son los siguientes:
        </p>
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
        ...
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
          ...
          datos personales que te conciernen infringe el Reglamento. Finalidad
        ...
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
          ...
          condiciones del sitio Web o de la contratación. Formularios de
          suscripción a contenidos: El Titular solicita los siguientes datos
          personales: Nombre y apellidos, dirección de correo electrónico,
          número de teléfono y dirección de tu sitio web para gestionar la lista
          de suscripciones, enviar boletines, promociones y ofertas especiales.
        </p>
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
          Los datos que facilites al Titular estarán ubicados en los servidores
          de The Rocket Science Group LLC d/b/a, con domicilio en EEUU.
          (Mailchimp).
        </p>
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
        ...
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
          ...
          redes sociales. Si te haces seguidor en las redes sociales del Titular
          el tratamiento de los datos personales se regirá por este apartado,
          así como por aquellas condiciones de uso, políticas de privacidad y
        ...
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
          En ningún caso el Titular utilizará los perfiles de seguidores en
          redes sociales para enviar publicidad de manera individual. Seguridad
        ...
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
          El sitio Web está alojado en Digital Ocean. La seguridad de tus datos
          ...
          tener más información. Contenido de otros sitios web
        </p>
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
        ...
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
          ...
          tu interacción usando este código. Política de Cookies
        </p>
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
        ...
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
          - Mailchimp The Rocket Science Group LLC d/b/a , con domicilio en
          EEUU.
        </p>
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
        ...
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
          - The Rocket Science Group LLC d/b/a trata los datos con la finalidad
          de prestar sus servicios de email el Titulareting al Titular.
        </p>
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
          - SendinBlue SendinBlue, sociedad por acciones simplificada (société
          par actions simplifiée) inscrita en el Registro Mercantil de París con
          el número 498 019 298, con domicilio social situado en 55 rue
        ...
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
          - SendinBlue trata los datos con la finalidad de ofrecer soluciones
          para el envío de correos electrónicos, SMS transaccionales y de el
          Titulareting al Titular.
        </p>
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
          - Google Analytics es un servicio de analítica web prestado por
          Google, Inc., una compañía de Delaware cuya oficina principal está en
          1600 Amphitheatre Parkway, Mountain View (California), CA 94043,
          Estados Unidos (“Google”). Encontrarás más información en:
          https://analytics.google.com
        </p>
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
          - Google Analytics utiliza “cookies”, que son archivos de texto
          ubicados en tu ordenador, para ayudar al Titular a analizar el uso que
          hacen los usuarios del sitio Web. La información que genera la cookie
          acerca del uso del sitio Web (incluyendo tu dirección IP) será
          directamente transmitida y archivada por Google en los servidores de
          Estados Unidos. DoubleClick by Google es un conjunto de servicios
          publicitarios proporcionado por Google, Inc., una compañía de Delaware
          cuya oficina principal está en 1600 Amphitheatre Parkway, Mountain
          View (California), CA 94043, Estados Unidos (“Google”). Encontrarás
          más información en: https://www.doubleclickbygoogle.com
        </p>
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
          - DoubleClick utiliza “cookies”, que son archivos de texto ubicados en
          tu ordenador y que sirven para aumentar la relevancia de los anuncios
          relacionados con tus búsquedas recientes. En la Política de privacidad
          de Google se explica cómo Google gestiona tu privacidad en lo que
        ...
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
          Al navegar por aimanager.online se pueden recoger datos no
        ...
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
          - DoubleClick por Google El Titular utiliza la información obtenida
          para obtener datos estadísticos, analizar tendencias, administrar el
          sitio, estudiar patrones de navegación y para recopilar información
          demográfica.
        </p>
        <p className="leading-relaxed text-2xl font-semibold text-gray-600 pt-8">
        ...
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
          Para ejercitar tus derechos de acceso, rectificación, cancelación,
          portabilidad y oposición tienes que enviar un correo electrónico a
          info@aimanager.online junto con la prueba válida en derecho como una
          fotocopia del D.N.I. o equivalente.
        </p>
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
